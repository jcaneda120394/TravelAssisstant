...
const CATALOG: CatalogEntry[] = [
  // Attractions & landmarks — Malolos / Bulacan core
  {
    id: 'local-barasoain',
    ...
    rating: 4.7,
    reviewCount: 6800,
    tags: ['church', 'heritage', 'attraction', 'famous'],
    description: 'Historic Malolos landmark and top place to visit in the city.',
  },
  {
    id: 'local-malolos-cathedral',
    name: 'Malolos Cathedral (Basilica Minore)',
    category: 'temple',
    latitude: 14.8436,
    longitude: 120.8119,
    ...
    rating: 4.6,
    reviewCount: 4200,
    tags: ['church', 'heritage', 'attraction'],
  },
  {
    id: 'local-casa-real',
    ...
    rating: 4.4,
    reviewCount: 1800,
    tags: ['museum', 'history', 'attraction'],
  },
  {
    id: 'local-capitol-bulacan',
    ...
    rating: 4.3,
    reviewCount: 2100,
    tags: ['park', 'landmark', 'attraction'],
  },
  {
    id: 'local-hap-chan-malolos',
    name: 'Hap Chan Restaurant Malolos',
    category: 'restaurant',
    latitude: 14.8455,
    longitude: 120.8142,
    address: 'Malolos, Bulacan',
  ...
  {
    id: 'local-max-malolos',
    name: "Max's Restaurant Malolos",
    category: 'restaurant',
    latitude: 14.8468,
    longitude: 120.8185,
    address: 'Malolos, Bulacan',
  ...
  // Attractions & landmarks — SJDM / greater Bulacan
  {
    id: 'local-sm-sjdm',
  ...
  {
    id: 'local-microtel',
    name: 'Microtel by Wyndham San Jose del Monte',
    category: 'hotel',
    latitude: 14.8,
    longitude: 121.05,
    address: 'San Jose del Monte, Bulacan',
